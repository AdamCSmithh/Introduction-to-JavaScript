...
function hungryDog (weightValue, years){
  if(years >= 0.99 && weightValue >= 5.0){
    return "5% of their body weight";
  } 
  else if(years <= 1.0 && weightValue >= 10.0){
    return "4% of their body weight";
  }
}
console.log(hungryDog(0.99, 4));
...
for(let i = number; i > 0; i-- ){
    return `${i} bottle of soda on the wall, ${i} bottles of soda, take one down pass it around ${i-1} bottles of soda on the wall`;}}
